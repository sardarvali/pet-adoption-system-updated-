document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadPets(page = currentPage) {
        try {
            ...
            // Filter out dogs and cats
            const otherPets = data.pets.filter(pet => 
            ...
            // Calculate total pages for other pets
            const totalOtherPets = data.counts.others;
            const totalPages = Math.ceil(totalOtherPets / petsPerPage);
